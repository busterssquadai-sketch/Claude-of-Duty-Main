...
def({ id: 'armor_paca', n: 'PACA Soft Armor', t: 'armor', cls: 'light', w: 3, h: 3, kg: 6.5, px: 22000, armor: 2, dur: 50 });
def({ id: 'helmet_ssh', n: 'SSH-68', t: 'helmet', w: 2, h: 2, kg: 1.5, px: 18000, armor: 3, dur: 35 });
